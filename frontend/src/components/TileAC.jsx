...
import MyAC from '../assets/ac.png'
...
export default function TileAC() {
  ...
  return (
    ...
    <Grid item xs={6}>
      <center>
        <img src={MyAC} alt="Logo" width = '120px'  style={{opacity: actopacity}} />
      </center>
         ...
         <div className={classes.root}>
            <center>
              <FormGroup>
                ...
                <p><PrettoSlider  marks={marks} min={16} max = {28} valueLabelDisplay="auto" aria-label="pretto slider" defaultValue={20} />
           </p>                   
